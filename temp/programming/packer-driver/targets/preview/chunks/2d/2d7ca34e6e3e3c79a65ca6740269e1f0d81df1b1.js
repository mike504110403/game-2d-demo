    ...
    execute: function () {
      ...
      _export("TeleportPortal", TeleportPortal = (_dec = ccclass('TeleportPortal'), _dec2 = property(cc.Node), _dec3 = property(cc.Vec2), _dec(_class = (_class2 = class TeleportPortal extends cc.Component {
        ...
        initializePortal() {
          ...
          if (!collider) {
            var newCollider = this.node.addComponent(cc.BoxCollider);
            newCollider.size = cc.size(100, 150);
            newCollider.isTrigger = true;
          } // 添加剛體


          var rigidBody = this.node.getComponent(cc.RigidBody2D);

          if (!rigidBody) {
            var newRigidBody = this.node.addComponent(cc.RigidBody2D);
        ...
        createPortalLabel() {
          var labelNode = new cc.Node('PortalLabel');
        ...
        startPortalAnimation() {
          ...
          var scaleUp = cc.scaleTo(1.0, 1.2);
          var scaleDown = cc.scaleTo(1.0, 0.8);
          var scaleSequence = cc.sequence(scaleUp, scaleDown);
          var scaleRepeat = cc.repeatForever(scaleSequence);
        ...
        playTeleportEffect() {
          // 建立傳送特效
          var effectNode = new cc.Node('TeleportEffect');
        ...
        createFlashEffect(parent) {
          var flashNode = new cc.Node('Flash');
          ...
          var sequence = cc.sequence(fadeOut, remove);
        ...
        createPortalSpriteFrame() {
          ...
          canvas.width = 100;
          canvas.height = 150;
          var ctx = canvas.getContext('2d'); // 繪製傳送門

          var gradient = ctx.createRadialGradient(50, 75, 0, 50, 75, 50);
        ...
        createFlashSpriteFrame() {
          ...
          canvas.width = 200;
          canvas.height = 200;
          var ctx = canvas.getContext('2d'); // 繪製閃光
