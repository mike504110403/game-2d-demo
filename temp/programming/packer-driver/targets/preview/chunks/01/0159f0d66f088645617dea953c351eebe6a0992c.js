    ...
    execute: function () {
      ...
      _export("MapleStoryScene", MapleStoryScene = (_dec = ccclass('MapleStoryScene'), _dec2 = property(cc.Node), _dec3 = property(cc.Node), _dec4 = property(cc.Node), _dec5 = property(cc.Node), _dec6 = property(cc.Prefab), _dec(_class = (_class2 = class MapleStoryScene extends cc.Component {
        ...
        createBackgroundSystem() {
          ...
          var parallaxComponent = this.backgroundContainer.addComponent(cc.Component); // 這裡需要導入 ParallaxBackground 類別
        }
        /**
         * 建立天空層
         */
        ...
        createSkyLayer() {
          var skyLayer = new cc.Node('SkyLayer');
        ...
        createCloudLayer() {
          var cloudLayer = new cc.Node('CloudLayer');
        ...
        createPlatformSystem() {
          // 添加平台生成器組件
          var platformGenerator = this.platformContainer.addComponent(cc.Component); // 這裡需要導入 PlatformGenerator 類別
          // 建立初始地面
        ...
        createCloudSpriteFrame() {
          ...
          canvas.width = 120;
          canvas.height = 60;
          var ctx = canvas.getContext('2d'); // 繪製雲朵
